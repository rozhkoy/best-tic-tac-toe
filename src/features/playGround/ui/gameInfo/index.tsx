		...
		<div className="game-info">
			{gameStatusMessage.isShow ? (
				...
				<div className="game-info__plate">
					...
					<div className="game-info__player">
						<span className={classNames('game-info__player-nickname game-info__player-nickname--right', { 'game-info__player-nickname--active': currentMove.player === playersData[1].nickName })}>{playersData[1].nickName}</span>
